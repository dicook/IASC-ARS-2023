...
::: {.fragment .f70}
It doesn't mean that it's easy. It doesn't mean that visualisation is used alone. It means that an important part of your toolbox, especially to allow discovery of what *we don't know*. 
:::
...
::: {.f70}
This is especially useful for exploring classification models, comparing boundaries produced by different models.
:::
